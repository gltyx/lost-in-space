...
var cnPrefix = {
    ...
    "Efficiency: ": "效率:",
    "Each accumulator inserted into the Battery Array increases its capacity by ": "插入电池组的每个蓄电池容量增加 ",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnRegReplace = new Map([
    ...
    [/^(.+)x CPU$/, '$1x CPU'],
    [/^(.+)x Empty Tank$/, '$1x 空罐'],
    [/^(.+)x Energy Grid Kit$/, '$1x 电网套件'],
    [/^(.+)x Memory Card$/, '$1x 存储卡'],
    [/^(.+)x Metal Scrap$/, '$1x 金属废料'],
    [/^(.+)x Rubber Sheet$/, '$1x Rubber Sheet'],
    [/^(.+)x Antenna$/, '$1x 天线'],
    [/^(.+)x Wire$/, '$1x 电线'],
    [/^(.+)x Transformator$/, '$1x 变压器'],
    [/^(.+)x Insulated Wire$/, '$1x 绝缘线'],
    [/^(.+)x Pipe$/, '$1x 管道'],
    [/^(.+)x Transistor Plate$/, '$1x 晶体管板'],
    [/^(.+)x Filter$/, '$1x 过滤器'],
    [/^(.+)x Experience$/, '$1x 经验值'],
    [/^(.+)x Accumulator$/, '$1x 蓄电池'],
    [/^(.+)x Beacon$/, '$1x 信标'],
    [/^Day ([\d\.,]+)$/, '天数 $1'],
